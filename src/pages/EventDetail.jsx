...
const EventDetail = () => {
    ...
    return (
        ...
        >
            <SEO
                title={`${event.name} – ERC BITS Goa`}
                description={event.description || PAGE_SEO.events.description}
                ogImage={masonryItems.find(i => i.type === 'image')?.img || PAGE_SEO.events.ogImage}
