...
function buildItems(pool, seg) {
    ...
    // Normalize items to ensure they have src and alt
    ...
    // Fill slots with items, repeating if necessary
...
export default function DomeGallery({
    ...
    const items = useMemo(() => buildItems(inputItems, segments), [inputItems, segments]);
